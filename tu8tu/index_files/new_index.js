...
{	
	window_box_close();
	setZero();		
	showPopWin('http://www.meijialz.com/pop_login.php?tmpyid='+tmpYid+'&phone='+phone, 500, 426, null, false);
}
...
function freeBooking(obj){
  ...
  bookingStr += '<input type="hidden"  value="1" name="rsastr">'
  bookingStr += '<input type="hidden"  id="ras" value="" name="phone">'
  ...
  bookingStr += '<li><span class="fb_title">手机号码</span><input type="text" name="prephone" id="phone" class="fq_text fq_text2"></li>';
