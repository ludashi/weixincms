...
define( function( require , exports , module ){
	...
	if((urlCity!='www')&&(urlCity!='xiaoguotu')&&(hasValue==-1)){
		...
		scriptNode.src="http://www.meijialz.com/zb/getCity.php?action=reset_cookie&url_city="+urlCity;
		scriptNode.type="text/javascript";
		document.getElementsByTagName('head')[0].appendChild(scriptNode);
	}

	/*document.getElementsByTagName('head')[0].appendChild('<script src="http://www.meijialz.com/zb/getCity.php?action=reset_cookie&url_city='+urlCity+'" type="text/javascript"></script>');
	/**
	...
	function setCookie(c_name, value, exdays) {
		...
		document.cookie = c_name + "=" + c_value + ';path=/;domain=.meijialz.com';
	}
	...
	{
		jq.get('http://www.meijialz.com/api/seo_keywords_process.php', keywords);
	}
	...
	jq(function(){
		...
		if(to8to_uid&&to8to_auth&& to8to_uid!=to8to_haslogin){
			jq.post('http://www.meijialz.com/api/insert_user_login.php',{to8to_auth:to8to_auth,to8to_uid:to8to_uid},function(data){
